...
<table class='mt-5'>
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="">
                    <button type="button"
                        class="w-12 h-12 m-2 text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm text-center"></button>
                    </a>
             </td>
                @elseif($i && $lugar->fila == $fila->fila)
                <th>
                <button disabled type="button" class="w-12 h-12 m-2  text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm"></button>
                </th>
                @endif
                @endforeach
                @endforeach
