...
@section('content')
    <div class="movie-info bord-b border-white ml-8 mr-8">
        <div class="container mx-auto px-4 py-16 sm:flex">
            <img class="h-96 w-64"
                src="{{ $filme->cartaz_url ? asset('storage/cartazes/' . $filme->cartaz_url) : asset('img/default_cartaz.png') }}">
            <div class="md:ml-24 ">
                <br>
                ...
                <div class="mt-16">
                    ...
                    <a href="{{ route('filmes.show_validar', ['filme'=>$filme]) }}">
                        <button type="button"
                            ...
                            <i class="fa fa-play mr-1" aria-hidden="true"></i> Validar Bilhetes deste filme</button>
                    </a>
                                ...
                                @foreach ($sessoes as $sessao)
                                    <tr
                                        ...
                                        <td class="text-center">
                                            <a
                                                href="{{ route('filmes.show_sessao', ['filme' => $filme, 'sessao' => $sessao]) }}">
                                                <button type="button"
