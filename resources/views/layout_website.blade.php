                    ...
                    <div class="flex flex-col space-y-4">
                        <a href="/" class="inline-flex flex-row items-center">
                            ...
                            <div>
                                ...
                                <svg class=" w-32 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                ...
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    @if (Auth::check() && auth()->user()->tipo == 'A')
                        <a href="{{ route('admin.dashboard') }}"
                            class="flex h-10 flex-row items-center px-3 text-black bg-gray-100 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-800  dark:border-gray-600 dark:placeholder-gray-400 dark:text-slate-800 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <li class="my-px">
                            ...
                            <div class="header-content flex flex-row items-center">
                                <div class="ml-auto flex">
                                    ...
                                    <!-- Dropdown menu -->
                                    <div id="dropdown"
                                        class="z-10 hidden bg-slate-800 divide-y divide-gray-100 rounded shadow">
                                        ...
                                        <ul class="px-4 py-6 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            @if (auth()->user()->tipo != 'O')
                                                <li>
                                                    ...
                                                    <a href="{{ route('user.show',['user', auth()->user()]) }}" style="text-decoration:none"
                                                        class="flex h-10 flex-row items-center px-3 text-gray-100 bg-slate-800 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-800  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                        <span class="flex items-center justify-center text-lg">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <div class="flex items-center justify-center">
                                <a href="{{ route('logout') }}"
                                    ...
                                    class="flex h-10 flex-row items-center px-3 text-white bg-green-500 hover:bg-black transition ease-out duration-500">
                                    <span class="flex items-center justify-center text-lg">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
